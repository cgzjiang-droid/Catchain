...
结果合同的JSON Schema位于`schemas/generated/evaluation-result.schema.json`；人工Gold合同位于`schemas/generated/gold-sample.schema.json`和`gold-dataset.schema.json`，可用`venv/bin/catchain schema export`重新生成全部15个Schema。
